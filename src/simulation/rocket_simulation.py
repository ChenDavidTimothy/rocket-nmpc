...
class RocketMPCParams:
    """Parameters for Rocket MPC controller"""
...
class RocketMPCSimulation:
    ...
    def _setup_optimization_problem(self):
        ...
        # Modified system dynamics to use combined angle like friend's implementation
        rhs = ca.vertcat(
    ...
    def _setup_constraints(self) -> Dict:
        """Setup optimization constraints with wider angle limits"""
        lbx = []
        ubx = []
        
        # State constraints with wider angle limits
        ...
        # Control constraints remain the same
    ...
    def simulate(self, x0: np.ndarray, xs: np.ndarray, sim_time: float = 20.0) -> Tuple[np.ndarray, List, List, List]:
        """Run MPC simulation with improved convergence criteria"""
        t0 = 0
        x = x0.copy()
